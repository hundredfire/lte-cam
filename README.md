...
- Secure storage and flexible configuration for your Telegram credentials and LTE details.

## Getting Started

### Hardware Requirements

- A supported microcontroller (e.g., ESP32, ESP8266, or equivalent) with camera support and LTE connectivity.*
...
- Power the device: it should connect to LTE, initialize the camera, and send photos at the scheduled times to your Telegram.
